...
describe('Element.* commands: perform.js.click', () => {
    it('clicks on element once it is present in DOM and visible', async () => {
        ...
        `);
        await base_1.browser.element('a').perform(something).then(lib_1.perform.js.click); // todo: did it really wait for visible?
...
//# sourceMappingURL=element.commands.perform.js.click.test.js.map