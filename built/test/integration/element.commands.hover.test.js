...
describe('Element.* commands: hover', () => {
    it('hovers on element once it is present in DOM and visible', async () => {
        ...
        await base_1.GIVEN.withBodyAfter(base_1.data.timeouts.smallest, `
        ...
        `);
        await base_1.browser.element('label').hover();
        expect(await base_1.textOf('label')).toContain('After hover');
    });
...
//# sourceMappingURL=element.commands.hover.test.js.map