...
describe('element.followingSibling', () => {
    it('should not be found on creation', async () => {
        const collection = base_1.browser.element('.not-existing').followingSibling;
    ...
    it('search is postponed until asking actual element data like "has specific text?"', async () => {
        ...
        `);
        const element = base_1.browser.element('li').followingSibling;
...
//# sourceMappingURL=element.followingSibling.test.js.map