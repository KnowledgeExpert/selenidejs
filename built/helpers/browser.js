...
(function (Browser) {
    ...
    async function resizeWindow() {
        await protractor_1.browser.manage().window().setSize(getValueFromPath(protractor_1.browser.params, 'windowSize.width'), getValueFromPath(protractor_1.browser.params, '.windowSize.eight'));
        windowResized = true;
    }
