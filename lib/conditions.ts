...
import { Condition, Lambda, Query } from './wait';
...
export namespace condition {
    ...
    export namespace element {
        ...
        export const isVisible = new Condition('is visible', throwIfNot(async (element: Element) =>
        ...
        export const hasVisibleElement = (by: By) =>
            new Condition(`has visible element located by ${by}`, throwIfNot(async (element: Element) =>
                (await element.element(by).getWebElement()).isDisplayed()));

        export const hasAttribute = (name: string) =>
            new Condition(`has attribute '${name}'`,
        ...
        export const hasText = (expected: string) => // todo: do we need string | number
            new Condition(`has text: ${expected}`,
                throwIfNotActual(query.text, predicate.includes(expected)));
        ...
        export const hasAttributeWithValue = (name: string, value: string) =>
            new Condition(`has attribute '${name}' with value '${value}'`,
                throwIfNotActual(query.attribute(name), predicate.equals(value)));


        export const hasAttributeWithValueContaining = (name: string, partialValue: string) =>
            new Condition(`has attribute '${name}' with value '${partialValue}'`,
                throwIfNotActual(query.attribute(name), predicate.includes(partialValue)));

        export const hasCssClass = (cssClass: string) =>
            new Condition(`has css class '${cssClass}'`,
    ...
    export namespace collection { // todo: collection vs Collection in collection.ts ?
        ...
        export const hasSizeLessThan = (size: number): CollectionCondition =>
            new Condition(`has size less than ${size}`,
    ...
    export namespace browser {
        ...
        export const hasTabsNumberLessThan = (num: number): BrowserCondition =>
            new Condition(`has tabs number less than ${num}`,
        ...
        export const hasJsReturnedTrue = (script: string | Function, ...args: any[]): BrowserCondition =>
            new Condition(`true is returned by js script: ${script}`, throwIfNot(async (browser: Browser) =>
