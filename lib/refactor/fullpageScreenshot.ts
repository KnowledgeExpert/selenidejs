...
export class FullpageScreenshot implements Query<Browser> {

    async perform(browser: Browser, ...args: any[]): Promise<any> {
        return this.take(browser.configuration.driver);
    }
